...
class RenkliDovme extends StatefulWidget {
  @override
  _RenkliDovmeState createState() => _RenkliDovmeState();
}
...
class _RenkliDovmeState extends State<RenkliDovme> {
  @override
